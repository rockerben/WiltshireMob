//
//  KitchenwareViewController.m
//  WiltshireMob
//
//  Created by rckrbn on 9/10/13.
//
//
...
@interface KitchenwareViewController ()
@property (nonatomic, strong) NSMutableArray *albums;
@end

@implementation KitchenwareViewController
...
- (void)viewDidLoad
{
    ...
    NSString *category = [NSString stringWithFormat:@"%@",linesarray [263] [1]];
