...
@interface BakewareViewController ()
@property (nonatomic, strong) NSMutableArray *albums;


@end

@implementation BakewareViewController
...
- (void)viewDidLoad
{
    ...
    NSString *category = [NSString stringWithFormat:@"%@",linesarray [1] [1]];
