...
NSString * const BHPhotoAlbumLayoutAlbumTitleKind1 = @"AlbumTitle";
...
- (void)prepareLayout
{
    ...
    for (NSInteger section = 0; section < sectionCount; section++) {
        ...
        for (NSInteger item = 0; item < itemCount; item++) {
            ...
            //album title will now become picture caption
                UICollectionViewLayoutAttributes *titleAttributes =
                [UICollectionViewLayoutAttributes layoutAttributesForSupplementaryViewOfKind:BHPhotoAlbumLayoutAlbumTitleKind1 withIndexPath:indexPath];
    ...
    newLayoutInfo[BHPhotoAlbumLayoutAlbumTitleKind1] = titleLayoutInfo;
...
{
    return self.layoutInfo[BHPhotoAlbumLayoutAlbumTitleKind1][indexPath];
}
