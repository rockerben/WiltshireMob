//
//  CookwareViewController.m
//  WiltshireMob
//
//  Created by rckrbn on 3/10/13.
//
//
...
@interface CookwareViewController ()
@property (nonatomic, strong) NSMutableArray *albums;

@end

@implementation CookwareViewController
...
- (void)viewDidLoad
{
    ...
    NSString *category = [NSString stringWithFormat:@"%@",linesarray [79] [1]];
